...
//       <h2 style={{color:"coral"}} key="h2">This is h2 tag</h2>
    ...
    return (
        <>
            <header className="header">
                ...
                <div className="right">
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSh8My6eIjeLWHZDgCVgC9c3tXCEg-TV-jA_WcQyWFlb0tTLMbO1GPJQXK6rJgw8HEWksU&usqp=CAU"
                        alt=""
                    />
                </div>
            </header>
